...
'''.format(ALL_CLOSED, THIRD_GOAT))
    ...
    while True:
        ...
        # Which door to show the player
        while True:
            # Select goat door not picked by player
        ...
        print(f'Door {showGoatDoor} has goat.')
        ...
        print(f'Door {doorThatHasCar} has car.')
