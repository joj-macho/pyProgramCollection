...
with open('hacking/sevenletterwords.txt') as wordListFile:
...
def main():
    print('''
Hacking Game
Find the password in the computer's memory. You are given clues after each guess. You get four guesses.\n''')
